"""
File Renamer Applet for Graphic Designers
...
class FileRenamerApp:
    ...
    def setup_ui(self):
        ...
        # Drop hint
        drop_label = ttk.Label(files_frame, text="💡 Tip: You can also drag and drop files here!",
                              foreground="gray")
        ...
        self.preview_listbox = tk.Listbox(preview_list_frame, height=6)
        ...
        ttk.Button(action_frame, text="Rename Files", command=self.rename_files,
    ...
    def setup_drag_drop(self):
        ...
        # Note: Full drag-drop from Windows Explorer requires additional packages like tkinterdnd2
        # This is a placeholder that can be enhanced with tkinterdnd2 if needed
        pass
